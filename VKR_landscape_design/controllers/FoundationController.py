...
@router.post("/foundations/delete")
...
@router.post("/foundations/insert")
...
@router.post("/foundations/update/name")
...
@router.post("/foundations/update/description")
...
@router.post("/foundations/update/picture")
...
@router.get("/foundations/get/picture")
