...
async def users_post_update_login(user_id: int, user_login: str):
    ...
    return Response("{'messlogin':'Имя пользователя обновлено.'}", status_code=200)
...
async def users_post_update_password(user_id: int, user_password: str):
    ...
    return Response("{'messpassword':'Имя пользователя обновлено.'}", status_code=200)
...
async def users_post_update_email(user_id: int, user_email: str):
    ...
    return Response("{'messemail':'Имя пользователя обновлено.'}", status_code=200)
...
async def users_post_update_isFemale(user_id: int, user_isFemale: bool):
    ...
    return Response("{'messisFemale':'Имя пользователя обновлено.'}", status_code=200)
...
async def users_post_update_picture(user_id: int, user_picture: str):
    ...
    return Response("{'messpicture':'Имя пользователя обновлено.'}", status_code=200)
...
async def users_post_update_isAdmin(user_id: int, user_isAdmin: bool):
    ...
    return Response("{'messisAdmin':'Имя пользователя обновлено.'}", status_code=200)