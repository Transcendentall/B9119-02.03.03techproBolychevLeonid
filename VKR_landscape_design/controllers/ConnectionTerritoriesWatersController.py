...
@router.get("/connectionterritorieswaters/all")
...
@router.get("/connectionterritorieswaters/one")
...
@router.post("/connectionterritorieswaters/insert")
...
@router.post("/connectionterritorieswaters/delete")
...
@router.post("/connectionterritorieswaters/update/territorieid")
...
@router.post("/connectionterritorieswaters/update/waterid")
