...
@router.post("/landscapes/update/name")
...
@router.post("/landscapes/update/description")
...
@router.post("/landscapes/update/picture")
...
@router.get("/landscapes/get/picture")
