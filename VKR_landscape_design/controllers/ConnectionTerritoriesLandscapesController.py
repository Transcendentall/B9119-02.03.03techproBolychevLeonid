...
@router.get("/connectionterritorieslandscapes/all")
...
@router.get("/connectionterritorieslandscapes/one")
...
@router.post("/connectionterritorieslandscapes/insert")
...
@router.post("/connectionterritorieslandscapes/delete")
...
@router.post("/connectionterritorieslandscapes/update/territorieid")
...
@router.post("/connectionterritorieslandscapes/update/landscapeid")
