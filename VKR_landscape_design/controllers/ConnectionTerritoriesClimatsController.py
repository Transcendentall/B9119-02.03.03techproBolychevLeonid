...
@router.get("/connectionterritoriesclimats/all")
...
@router.get("/connectionterritoriesclimats/one")
...
@router.post("/connectionterritoriesclimats/insert")
...
@router.post("/connectionterritoriesclimats/delete")
...
@router.post("/connectionterritoriesclimats/update/territorieid")
...
@router.post("/connectionterritoriesclimats/update/climatid")
