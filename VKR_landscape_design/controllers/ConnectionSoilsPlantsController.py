...
async def connection_soils_grounds_post_update_soil_id(connection_soils_grounds_id: int, connection_soils_grounds_soil_id: str):
    conn = get_db_connection()
...
async def connection_soils_grounds_post_update_ground_id(connection_soils_grounds_id: int, connection_soils_grounds_ground_id: str):
    conn = get_db_connection()
