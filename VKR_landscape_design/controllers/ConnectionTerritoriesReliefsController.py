...
@router.get("/connectionterritoriesreliefs/all")
...
@router.get("/connectionterritoriesreliefs/one")
...
@router.post("/connectionterritoriesreliefs/insert")
...
@router.post("/connectionterritoriesreliefs/delete")
...
@router.post("/connectionterritoriesreliefs/update/territorieid")
...
@router.post("/connectionterritoriesreliefs/update/reliefid")
