...
@router.post("/reliefs/update/name")
...
@router.post("/reliefs/update/description")
...
@router.post("/reliefs/update/picture")
...
@router.get("/reliefs/get/picture")
