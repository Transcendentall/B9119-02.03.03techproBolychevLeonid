...
@router.get("/connectionterritoriesfoundations/all")
...
@router.get("/connectionterritoriesfoundations/one")
...
@router.post("/connectionterritoriesfoundations/insert")
...
@router.post("/connectionterritoriesfoundations/delete")
...
@router.post("/connectionterritoriesfoundations/update/territorieid")
...
@router.post("/connectionterritoriesfoundations/update/foundationid")
